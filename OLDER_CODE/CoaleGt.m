...
% This m script give ex from mx, using Coale-Guo  
function [nmx]= CoaleGt(drt)

%keyboard;

 A=110;
% drt, 18 age-specific death rates for 0, 1-4, 5-9,...80-84.
%nmx, 22, age-specific death rates for 0, 1-4, 5-9,...100-104.
%Get lx, Lx for 0,...80-84; using Lifetable(mx_ages, mx_data)
...
HA=A-85+1;
s=(log(mA/m84)-HA*k85)*2/(HA*(HA-1));%41 is the H for A=125 in Tulja's Eq
for i=1:HA
...
nLx(19+HB)=lx(HA);%the last open interval
